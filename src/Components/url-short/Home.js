                    ...
                    <form onSubmit={handleUrl}>
                        <div className="row">
                            <div className="input-group mb-3">
                                <input type="text" name="longurl" className="form-control shadow-none" placeholder="Paste Your URL Here"
                                    aria-label="Recipient's username" aria-describedby="button-addon2" value={longUrl} onChange={(e) => setLongurl(e.target.value)} />
                            </div>
                            <div className="form-group text-center">
                                    <input type="submit" style={{color:"white"}} className="btn btn-success ps-5 pe-5" value="Submit" />
                            </div>
                        </div>
                    </form>
                </div>
